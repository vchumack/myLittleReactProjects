...
export const User = ({ id, email, first_name, last_name, avatar, onClickInvites, isInvited }) => {
	const plusMinusActionSrc = `${isInvited ? minus : plus} `;
	...
	return (
		...
		<img onClick={() => onClickInvites(id)} className={styles.action} src={plusMinusActionSrc} alt="Action" />
	</li>
	)
};
